...
window.onload = function () {
  ...
  const p1DrawBtn_2 = document.getElementById("p1_draw_btn_2");
  const p1ShuffleBtn_2 = document.getElementById("p1_shuffle_btn_2");
  const p1DeckBtn_2 = document.getElementById("p1_deck_btn_2");
  const p1Deck5_2 = document.getElementById("p1_deck_5_2");
  ...
  document.getElementById("gx_hide").onclick = function () {
    if (document.getElementById("p1_GX").style.display == "none") {
      document.getElementById("p1_GX").style.display = "block";
      document.getElementById("p1_GX").style.display = "block";
      document.getElementById("gx_hide").innerText = "GXマーカー非表示"
    } else {
      document.getElementById("p1_GX").style.display = "none";
      document.getElementById("p1_GX").style.display = "none";
      document.getElementById("gx_hide").innerText = "GXマーカー表示"
    }
  }
  ...
  shareBtn.onclick = function (event) {
    if (leftCode.value) {
      const url = "https://twitter.com/intent/tweet?text=このデッキを使ってみて！&hashtags=ポケカデッキシェア&url=https://funamushi.net/pokeca_hitorimawashi/pokeca_deck_check?deck1=" + leftCode.value;
  ...
  editBtn.onclick = function (event) {
    if (leftCode.value) {
      const url = "https://www.pokemon-card.com/deck/deck.html?deckID=" + leftCode.value;
      editBtn.setAttribute('href', url);
    };
  }
  ...
  p1DrawBtn.onclick = p1DrawBtn_2.onclick = function () {
    document.getElementById("p1_hand_wrap").appendChild(document.getElementById("p1_deck_wrap").firstElementChild)
    setTimeout(() => {
    }, 1000);
  };

  p1ShuffleBtn.onclick = p1ShuffleBtn_2.onclick = function () {
    let temp = Array.from(document.getElementById("p1_deck_wrap").children)
    temp.shuffle()
    document.getElementById("p1_deck_wrap").innerHTML = ""
    temp.forEach(_node => document.getElementById("p1_deck_wrap").appendChild(_node))
    if (document.getElementById("p1_deck").style.display != "none") {
      ...
      p1DeckBtn.value = p1DeckBtn_2.value = "デッキを見る"
      p1Deck5.value = p1Deck5_2.value = "山上5枚見る"
    }
  }

  p1DeckBtn.onclick = p1DeckBtn_2.onclick = function () {

    if (document.getElementById("p1_deck").style.display == "none") {
      document.getElementById("p1_deck").style.display = "flex";
      p1DeckSort.style.display = "inline";
      window.scrollTo(0, document.body.scrollHeight);
      p1DeckBtn.value = p1DeckBtn_2.value = "デッキを閉じる"
      p1Deck5.value = p1Deck5_2.value = "シャッフル閉じる"
    } else {
      document.getElementById("p1_deck").style.display = "none";
      p1Deck7.style.display = "none";
      p1DeckSort.style.display = "none";
  ...
  p1Deck5.onclick = p1Deck5_2.onclick = function () {
    if (document.getElementById("p1_deck").style.display == "none") {
      document.getElementById("p1_deck").style.display = "flex";
  ...
  const p1FreeTrash = document.getElementById("p1_free_trash")
  ...
  p1FreeTrash.onclick = function () {
    let free = Array.from(document.getElementById("p1_free_space_wrap").children)
    document.getElementById("p1_free_space_wrap").innerHTML = "";
    free.forEach(_node => p1TrashWrap.appendChild(_node))
  }
