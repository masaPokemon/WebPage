$(function(){$(window).width()<$(window).height()?($('link[rel=stylesheet]').attr("href","assets/base_h.css"),$(".vmw").hide(),$(".vmh").show()):($('link[rel=stylesheet]').attr("href","assets/base.css"),$(".vmw").show(),$(".vmh").hide())});
zoom();
